...
const footerLinks = {
  ...
  contact: [
    { icon: MapPin, text: 'El Mey, Midoun, Djerba' },
    { icon: Phone, text: '+216 23 170 693' },
    { icon: Mail, text: 'contact@energiflow.com' },
  ],
};
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">EnergiFlow</span>
            </Link>
        ...
        <div className="border-t border-border py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} EnergiFlow. All rights reserved.
            </p>
